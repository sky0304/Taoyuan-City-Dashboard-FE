...
export const MapObjectConfig = {
	antialias: true,
	container: "mapboxBox",
	center: [121.300901, 24.993601],
	maxBounds: [
		[121.050000,24.666666], // Southwest coordinates
		[121.355555, 25.055000], // Northeast coordinates
	],
	zoom: 12.5,
	minZoom: 11,
	maxZoom: 22,
...
export const maplayerCommonLayout = {
	...
	"symbol-school": {
		...
		"icon-size": [
		 ...
		 ["zoom"],
		 11.99,
		 0.05,  // 将初始缩小比例调整为更小的值，例如 0.5
		 14,
		 0.1,  // 在中间缩放级别使用适度的缩放比例，例如 0.8
		 22,
		 1.2
		],
	   },
